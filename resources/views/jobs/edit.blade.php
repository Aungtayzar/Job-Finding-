<x-layout>
    <x-slot name="title"> Update Job </x-slot>
    <div
            ...
            >
                ...
                @method('PUT')
                    ...
                    <x-inputs.text id="salary" label="Annual Salary" type="number" name="salary" placeholder="90000" :value="old('salary',$job->salary)"/>
                    ...
                    <x-inputs.text id="tags" label="Tags (comma-separated)" name="tags" placeholder="development,coding,java,python" :value="old('tags',$job->tags)"/>
                    ...
                    <x-inputs.text id="address" label="Address" name="address" placeholder="123 Main St" :value="old('address',$job->address)"/>
                    ...
                    <x-inputs.text id="zipcode" label="ZIP Code" name="zipcode" placeholder="12201" :value="old('zipcode',$job->zipcode)"/>
                    ...
                    <x-inputs.text id="company_website" label="Company Website" type="url" name="company_website" placeholder="Enter website" :value="old('company_website',$job->company_website)"/>

                    <x-inputs.text id="contact_phone" label="Contact Phone" name="contact_phone" placeholder="Enter phone" :value="old('contact_phone',$job->contact_phone)" />

                    <x-inputs.text id="contact_email" type="email" label="Contact Email" name="contact_email" placeholder="Email where you want to receive applications" :value="old('contact_email',$job->contact_email)"/>
